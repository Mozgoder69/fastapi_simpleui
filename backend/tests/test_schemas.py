...
# from schemas.dynamic_json import SchemaGenerator
...
#     generator = SchemaGenerator(mock_metadata["person"])
#     schema = generator.base_schema
...
#     generator = SchemaGenerator(mock_metadata["person"])
#     actual_schema = generator.base_schema
#     expected_schema = {
